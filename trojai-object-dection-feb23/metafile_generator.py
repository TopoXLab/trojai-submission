...
#Github link
url='https://github.com/luluppang/trojai.git'
#commit id
...
"technique": "RandomForestClassifier","technique_type": ["Weight Analysis"],"technique_description": "Enumerate training examples and analyze weights.","technique_changes": "First commit. Focusing on generality and compliance.","commit_id": sha,"repo_name": url,"required": [],"additionalProperties": False,"type": "object"}
