...
#         clf = load('/scratch/jialin/round-10/projects/weight_analysis/src/classifier_model_A_v2.joblib')
#     elif predict_model_class == 'B':
#         clf = load('/scratch/jialin/round-10/projects/weight_analysis/src/classifier_model_B_v2.joblib')
#     else:
...
mean ce_A:  0.35656959210055755 mean ce_B:  0.6451717276951818
mean acc_A:  0.856 mean acc_B:  0.7226666666666667
