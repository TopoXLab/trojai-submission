...
if __name__ == '__main__':
    ...
    logging.info("test: weight analysis classifier launched")

    if args.model_filepath is not None:
        logging.info('test: Calling the weight analysis classifier')
        weight_analysis_detector(args.model_filepath)


'''
mean ce_A:  0.40068492880011375 mean ce_B:  0.5889139362437111
mean acc_A:  0.8506666666666665 mean acc_B:  0.7573333333333335
'''
