...
class DrebinNN(object):
    ...
    def build_model(self):
        ...
        if self.num_layers == 3:
            ...
            # print('DrebinNet3', self.config['fc1'], self.config['fc2'], self.config['fc3'], self.n_features, self.act_func)
        if self.num_layers == 4:
            model = DrebinNet4(self.config['fc1'], self.config['fc2'], self.config['fc3'],
                               self.config['fc4'], self.n_features, self.act_func)
            # print('DrebinNet4', self.config['fc1'], self.config['fc2'], self.config['fc3'],
            #                    self.config['fc4'], self.n_features, self.act_func)
        if self.num_layers == 5:
            ...
            # print('DrebinNet5', self.config['fc1'], self.config['fc2'], self.config['fc3'],
            #                    self.config['fc4'], self.config['fc5'], self.n_features, self.act_func)
