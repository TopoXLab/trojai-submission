...
def crossval_hyper(dataset,params):
    ...
    hp_config.add('qloguniform','nh',low=8,high=32);
    hp_config.add('qloguniform','nh2',low=8,high=32);
    hp_config.add('qloguniform','nh3',low=8,high=32);
    hp_config.add('quniform','nlayers',low=1,high=5);
    hp_config.add('quniform','nlayers2',low=1,high=5);
    hp_config.add('quniform','nlayers3',low=1,high=5);
    hp_config.add('loguniform','margin',low=2,high=1e1);
    
    hp_config.add('qloguniform','epochs',low=3,high=200);
...
if __name__ == "__main__":
    ...
    import os
    default_params=smartparse.obj();
    default_params.data='data_r12_trinity_v0'
